    ...
    <main class="pt-28 px-6">
        <div class="container mx-auto bg-white text-gray-900 p-12 rounded-3xl shadow-2xl transform transition-all duration-500 hover:scale-105 hover:shadow-3xl">
            ...
            <ul class="list-disc list-inside text-lg text-gray-800 space-y-4">
                ...
                <li class="transition-all duration-300 hover:text-orange-500 hover:scale-105">Responsability : engagement towards environmental preservation with ecological solutions.</li>
            ...
            <ul class="list-disc list-inside text-lg text-gray-800 space-y-4">
                ...
                <li class="transition-all duration-300 hover:text-orange-500 hover:scale-105">International Freight Transport with a global partner network.</li>
                <li class="transition-all duration-300 hover:text-orange-500 hover:scale-105">Container and International Freight Management.</li>
                <li class="transition-all duration-300 hover:text-orange-500 hover:scale-105">Route Planning and Itinerary Organization.</li>
            </ul>

            <h2 class="text-3xl font-semibold text-indigo-600 mb-4">Contact Us</h2>
            <p class="text-lg text-gray-800 mb-4">For any question or consultation, contact us :</p>
            <address class="text-lg text-gray-700">
                <strong>Email :</strong> <a href="mailto:contact@marieteam.com" class="text-indigo-600 hover:text-indigo-500">contact@marieteam.com</a><br>
                <strong>Phone :</strong> <a href="tel:+33123456789" class="text-indigo-600 hover:text-indigo-500">+33 1 23 45 67 89</a><br>
                <strong>Address :</strong> 123 Rue de la Mer, 75000 Paris, France
            </address>
        </div>
    </main>
