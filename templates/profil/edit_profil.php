<?php if(isset($_SESSION['user'])): ?>
    <div class="container mx-auto max-w-lg p-8 bg-white shadow-lg rounded">
        ...
        <form action="try_editProfil/<?= $_SESSION['user']['id_Utilisateur'] ?>" method="post">
            ...
            <button type="submit" class="w-40 bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700">Edit</button>
